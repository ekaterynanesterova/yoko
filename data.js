...
const TYPES = [
 ...
 {id:"big", cut:true, frame:false, ru:"Big Rolls", de:"Big Rolls", rice:0, pcs:5, c:"var(--green)",
  rule:"Начинка как у Yoko Roll, но <b>без фритюра</b>. Режем на <b>5 кусков</b>. Граммовку риса уточнить."},
 {id:"yoko", cut:true, ru:"Yoko Rolls", de:"Yoko Rolls", rice:120, pcs:5, c:"var(--amber)",
  rule:"<b>Жарятся в темпуре.</b> Сверху всегда Sweet Sauce + кунжут. Режем на <b>5 кусков</b>."},
...
/* ============================================================
   ...
   То же, что лежит в ВОПРОСЫ.md, только на виду: Kate читает это с
   телефона на смене и задаёт вопрос, когда шеф рядом. Получен ответ —
   вопрос уходит отсюда, а решение переезжает в данные.
   ============================================================ */
const ASK = [
 { g: "Коробки для одиночных позиций", items: [
   { q: "Yoko Roll поштучно — точно коробка M?",
     why: "Записано с твоих слов, но ты сказала «по-моему». В сборочном листе пока стоит пометка, что у шефа не подтверждено." },
   { q: "Нежареный ролл на 8 кусков — California, Philadelphia, Alaska. Какая коробка?",
     why: "Они крупнее маки, а маки идут в S. Тоже S или больше?" },
   { q: "Mini Yoko Roll поштучно — S?",
     why: "Жареные, но мелкие, 8 кусков." },
   { q: "Нигири парой и летние роллы поштучно — какая коробка?",
     why: "Размера нет ни в папке, ни в каталоге." },
   { q: "Два-три одиночных ролла в одном заказе — вместе в одну коробку или каждый в свою?",
     why: "От этого зависит счёт коробок в сборочном листе." }
 ]},
 { g: "Big Roll и новые меню", items: [
   ...
   { q: "Snacks & Rolls (18 шт) — какая коробка и что в комплект?",
     why: "Меню с витрины: 5 мини спринг-роллов, 8 Maki Sake Avocado, 5 Big Roll Chicken." },
...
const CATS = {
 ...
 big:{short:"Big Rolls", ru:"Big Rolls", sub:"Как Yoko Roll, но без фритюра", cols:3, band:"--green-band", ink:"--green-ink"},
...
const PREPS_BASE = [
 ...
 {ru:"Варка риса",de:"Reis kochen",items:[["3 кг","рис"],["600 мл","готовой уксусной смеси"]],
  steps:["Отвесить 3 кг риса, промыть под проточной водой <b>3 раза</b>.","Замочить на <b>45 минут — 1 час</b>.","В рисоварку, залить водой до <b>2600 мл</b>.","Варить <b>1 час</b>.","Заправить 600 мл уксусной смеси."]},
...
const MENUCARDS = [
 {name:"Snacks & Rolls", pcs:18, box:"", kit:"",
  note:"С Lieferando, 19,30 €. Коробка и комплект не указаны — уточнить",
  items:[[5,"Mini Frühlingsrollen"],[8,"Maki Sake Avocado"],[5,"Big Roll Chicken"]]},

 {name:"Veggie Combi", pcs:13, box:"", kit:"",
  note:"С Lieferando, 17,20 €. Идёт по акции «2 für 1» во вторник. Коробка и комплект не указаны — уточнить",
